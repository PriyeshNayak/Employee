    ...
    loginMachine(machine, password) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (error.captainStatus === ErrorFactory_1.default.STATUS_ERROR_OTP_REQUIRED) {
                    StdOutUtil_1.default.printWarning('You must also pass CAPROVER_OTP_TOKEN environment variable, e.g. CAPROVER_OTP_TOKEN=123456; caprover login');
                    return;
                }
